(function() {
  angular.module('divelog', [])
    .controller('DiveLogController', ['$scope', '$mdBottomSheet', DiveLogController])
    .controller('BottomSheetController', ['$scope', '$mdBottomSheet', '$mdToast', BottomSheetController]);

  function DiveLogController($scope, $mdBottomSheet) {
    $scope.dives = [
      {
